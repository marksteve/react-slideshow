...
function init(e){React.render(React.createElement(ReactSlideshow,{auth:e,firebase:firebase}),document.getElementById("react-slideshow"))}window.React=require("react/addons"),require("Mousetrap");var Firebase=require("firebase"),Slide=require("./slide"),Spinner=require("./spinner"),firebase=new Firebase("https://react-slideshow.firebaseio.com"),ReactSlideshow=React.createClass({displayName:"ReactSlideshow",getInitialState:function(){return{slides:{},currentSlide:null}},componentWillMount:function(){var e=this.props.firebase.child("slides").orderByKey();e.on("child_added",this.updateSlide),e.on("child_changed",this.updateSlide);var t=this.props.firebase.child("currentSlide");t.on("value",this.updateCurrentSlide)},componentDidMount:function(){Mousetrap.bind("left",this.prevSlide),Mousetrap.bind("right",this.nextSlide)},componentDidUpdate:function(e,t){if(t.currentSlide!=this.state.currentSlide)if(t.currentSlide){var i,s,r=Object.keys(this.state.slides);r.indexOf(t.currentSlide)>r.indexOf(this.state.currentSlide)?(i="transition.slideLeftBigIn",s="transition.slideRightBigOut"):(i="transition.slideRightBigIn",s="transition.slideLeftBigOut"),Velocity(this.refs[t.currentSlide].getDOMNode(),s,{duration:200}),Velocity(this.refs[this.state.currentSlide].getDOMNode(),i,{duration:200,delay:100})}else Velocity(this.refs[this.state.currentSlide].getDOMNode(),"transition.fadeIn")},updateSlide:function(e){var t={};t[e.key()]={$set:e.val()},this.setState(React.addons.update(this.state,{slides:t})),console.log("Loaded slide",e.key())},updateCurrentSlide:function(e){this.setState({currentSlide:e.val()}),console.log("Current slide",this.state.currentSlide)},renderSlides:function(){var e=Object.keys(this.state.slides).map(this.renderSlide);return e.length>0?e:React.createElement(Spinner,null)},renderSlide:function(e){return React.createElement(Slide,React.__spread({ref:e,key:e},this.state.slides[e]))},currentIndex:function(){return Object.keys(this.state.slides).indexOf(this.state.currentSlide)},prevSlide:function(){var e=this.currentIndex()-1,t=Object.keys(this.state.slides);e>=0&&this.props.firebase.child("currentSlide").set(t[e])},nextSlide:function(){var e=this.currentIndex()+1,t=Object.keys(this.state.slides);e<t.length&&this.props.firebase.child("currentSlide").set(t[e])},addSlide:function(){var e=this.props.firebase.child("slides").push({title:"Slide title",content:"Slide content"});this.props.firebase.child("currentSlide").set(e.key())},editSlide:function(){},render:function(){return React.createElement("div",{className:"screen"},React.createElement("div",{className:"slides"},this.renderSlides()),React.createElement("div",{className:"controls"},React.createElement("button",{className:"edit-slide",onClick:this.editSlide},"Edit slide"),React.createElement("button",{className:"add-slide",onClick:this.addSlide},"New slide")))}}),auth=firebase.getAuth();auth?(console.log("Logged in as",auth),init(auth)):firebase.authWithOAuthPopup("github",function(e){e&&alert(e)});
